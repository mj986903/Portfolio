    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
        ...
        <p className="text-base md:text-lg text-muted-foreground/80 mb-12 max-w-xl mx-auto">
          Passionate about crafting dynamic web apps. Love blending design and
          functionality to create seamless tech experiences. Always exploring
          the latest in web and AI innovations.
        </p>
